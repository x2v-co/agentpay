...
export function overview(s) {
  ...
  return `<section class="screen overview-screen">
    <div class="overview-heading"><div><span class="eyebrow">COMMISSION ACCEPTED / THE COMPLETE LOOP</span><h1>A job. A boundary.<br>A way forward.</h1></div><p>You set the policy. KITE-07 preserved the task, found a fulfillment route, and returned for your verification.</p></div>
    <div class="overview-outcome"><span><b>${money(s.budget)} USDC</b> task budget</span><span><b>${s.mode === 'auto' ? 'Autonomous' : 'Approved by you'}</b> procurement policy</span><span><b>3 / 3 passing</b> accepted locally</span><span><b>No new charge</b> historical payment replay</span></div>
